                    ...
                    <div className="listing-item blog-info">										
                      <div className="listing-img">
                        <Link to={routes.blogDetails}>
                          <ImageWithBasePath src="assets/img/blog/blog-04.jpg" className="img-fluid" alt="Venue" />
                        </Link>
                      ...
                      <div className="listing-content news-content">
                        <div className="listing-venue-owner blog-detail-owner d-lg-flex justify-content-between align-items-center">
                          <div className="navigation">
                            ...
                            <span><i className="feather-calendar" />15 May 2023</span>
                            <span><i className="far fa-comment-alt" />30 Comments</span>
                          </div>
                          <Link to="#" className="btn btn-primary"><ImageWithBasePath src="assets/img/icons/grid.svg" className="img-fluid" alt="Icon" />Rules of Game</Link>		
                        </div>
                        {/* <hr> */}
                        <h2 className="listing-title">
                          <Link to="#">Mastering the Badminton Basics: A Guide for Beginners</Link>
                        </h2>
                        ...
                        <div className="gradient-bg d-flex justify-content-between align-items-center">
                          <ImageWithBasePath src="assets/img/icons/comment-quotes.svg" className="img-fluid" alt="Icon" />
                          <p className="mb-0">There are many variations of passages of at Lorem Ipsum available but the majority the have too suffered alteration. There are many variations of passages of Lorem Ipsum vailable majority have that suffered alteration words which don&apos;t look even slightly believable.</p>
                        </div>
                        ...
                        <div className="blog-images d-sm-flex align-items-center justify-content-start">
                          <Link to="#"><ImageWithBasePath src="assets/img/blog/blog-05.jpg" className="img-fluid" alt="Venue" /></Link>
                          <Link to="#"><ImageWithBasePath src="assets/img/blog/blog-06.jpg" className="img-fluid" alt="Venue" /></Link>
                          <Link to="#"><ImageWithBasePath src="assets/img/blog/blog-07.jpg" className="img-fluid" alt="Venue" /></Link>
                        </div>
                        <p>Lorem Ipsum available but the or majority have that suffered alteration words which don&apos;t look even slightly believable. There are many available but the majority the have suffered alteration. There are many variations of dummy passages Lorem majority the have the suffered alteration. There are many variations of passages of at Lorem Ipsum available but the majority suffered that dummy is alteration. There are many variations of passages of Lorem Ipsum available but the or majority have that suffered alteration words which don&apos;t look even slightly believable.</p>
                        <ul className="text-list">
                          <li>dummy passages Lorem majority</li>
                          <li> Lorem Ipsum is not simply random text</li>
                          <li>It has roots in a piece of classical Latin literature</li>
                    ...
                    <div className="row align-items-center">
                      <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                        <div className=" d-flex align-items-center tags-wrapper">
                          <h6>Tags:</h6>
                          <ul className="tags">
                            <li><Link to="#" className="tag">Rackets</Link></li>
                            <li><Link to="#" className="tag">New Game</Link></li>
                            <li><Link to="#" className="tag">Dresses</Link></li>
                          </ul>	
                        </div>
                      </div>
                      <div className="col-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <div className="dull-bg author-widget">
                      <div className=" author-group d-md-flex align-items-center justify-content-start">
                        <div className="profile-pic">
                          <Link to="#;" className="d-inline-block"><ImageWithBasePath src="assets/img/profiles/avatar-01.jpg" alt="User" /></Link>
                        </div>
                        <div className="info">
                          <span>Author</span>
                          <h5>Antony Hilfn</h5>
                    ...
                    <div className="dull-bg">
                      ...
                      <ul>
                        <li className="author-group d-md-flex align-items-center justify-content-start">
                          <div className="profile-pic">
                            <Link to="#;" className="d-inline-block"><ImageWithBasePath src="assets/img/profiles/avatar-04.jpg" alt="User" /></Link>
                          </div>
                          <div className="info">
                        ...
                        <li className="author-group d-md-flex align-items-center justify-content-start">
                          <div className="profile-pic">
                            <Link to="#;" className="d-inline-block"><ImageWithBasePath src="assets/img/profiles/avatar-05.jpg" alt="User" /></Link>
                          </div>
                          <div className="info">
                            <div className="head d-flex align-items-center justify-content-start">
                              <h5>Besant</h5>
                        ...
                        <li className=" author-group d-md-flex align-items-center justify-content-start">
                          <div className="profile-pic">
                            <Link to="#;" className="d-inline-block"><ImageWithBasePath src="assets/img/profiles/avatar-06.jpg" alt="User" /></Link>
                          </div>
                          <div className="info">
                            <div className="head d-flex align-items-center justify-content-start">
                              <h5>Maria Fin</h5>
