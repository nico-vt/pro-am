    ...
    <div>
      ...
      <section className="breadcrumb breadcrumb-list mb-0">
        ...
        <div className="container">
          <h1 className="text-white">Venue List With Sidebar</h1>
          <ul>
            <li>
              <Link to={routes.home}>Home</Link>
            </li>
            <li>Venue List With Sidebar</li>
          </ul>
        </div>
      </section>
      {/* /Breadcrumb */}
                      ...
                      <div className="sortby-filter-group">
                        <div className="grid-listview">
                          <ul className="nav">
                            ...
                            <li>
                              <Link to={routes.listingMapSidebar}>
                                <ImageWithBasePath
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={1} onClick={() => handleItemClick(1)} className={`fav-icon ${selectedItems[1] ? "selected" : ""}`}>
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={2} onClick={() => handleItemClick(2)} className={`fav-icon ${selectedItems[2] ? "selected" : ""}`}>
                              <i className="feather-heart" />
                            </Link>
                          </div>
                          <h3 className="listing-title">
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={3} onClick={() => handleItemClick(3)} className={`fav-icon ${selectedItems[3] ? "selected" : ""}`}>
                              <i className="feather-heart" />
                            </Link>
                          </div>
                          <h3 className="listing-title">
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={4} onClick={() => handleItemClick(4)} className={`fav-icon ${selectedItems[4] ? "selected" : ""}`}>
                              <i className="feather-heart" />
                            </Link>
                          </div>
                          <h3 className="listing-title">
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={5} onClick={() => handleItemClick(5)} className={`fav-icon ${selectedItems[5] ? "selected" : ""}`}>
                              <i className="feather-heart" />
                            </Link>
                          </div>
                          <h3 className="listing-title">
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={6} onClick={() => handleItemClick(6)} className={`fav-icon ${selectedItems[6] ? "selected" : ""}`}>
                              <i className="feather-heart" />
                            </Link>
                          </div>
                          <h3 className="listing-title">
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={7} onClick={() => handleItemClick(7)} className={`fav-icon ${selectedItems[7] ? "selected" : ""}`}>
                              <i className="feather-heart" />
                            </Link>
                          </div>
                          <h3 className="listing-title">
                      ...
                      <div className="listing-item listing-item-grid">
                        ...
                        <div className="listing-content">
                          <div className="list-reviews">
                            ...
                            <Link to="#" key={8} onClick={() => handleItemClick(8)} className={`fav-icon ${selectedItems[8] ? "selected" : ""}`}>
                              <i className="feather-heart" />
                            </Link>
                          </div>
                          <h3 className="listing-title">
