    ...
    <div>
      ...
      <section className="breadcrumb breadcrumb-list mb-0">
        ...
        <div className="container">
          <h1 className="text-white">Coaches Grid Without Sidebar</h1>
          <ul>
            <li>
                  ...
                  <div className="listing-content">
                    ...
                    <div className="listing-details-group">
                      <p>
                        ...
                        skills and unlocking your full potential and strategies.
                      </p>
                    </div>
                    <div className="coach-btn">
                      <ul>
                  ...
                  <div className="listing-content">
                    ...
                    <div className="listing-details-group">
                      <p>
                        ...
                        through strategic gameplay and strategies.
                      </p>
                    </div>
                    <div className="coach-btn">
                      <ul>
                  ...
                  <div className="listing-content">
                    ...
                    <div className="listing-details-group">
                      <p>
                        ...
                        abilities and tactics the game.
                      </p>
                    </div>
                    <div className="coach-btn">
                      <ul>
